import 'package:crru_app/register.dart';
import 'package:flutter/material.dart';
import 'package:crru_app/main.dart';
import 'package:crru_app/login_screen.dart';
import 'package:http/http.dart' as http;
import 'package:crru_app/menu_screen.dart';
...
// URL ของ API ที่คุณต้องการเรียกใช้ (saveregister.php)
    String apiUrl = 'http://localhost:81//crru_API/checklogin.php';
//print(apiUrl);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(
                image: AssetImage(
                    'images/crru.png'), // เปลี่ยนเป็นที่อยู่ของรูปภาพที่คุณใช้
